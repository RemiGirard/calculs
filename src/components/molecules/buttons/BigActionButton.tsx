...
const BigActionButton = (
  ...
  return (<div onClick={onClick} style={{color: textColor, backgroundColor : color, borderRadius: '5px', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '4em', ...style}}>
    {children}
  </div>);
}
