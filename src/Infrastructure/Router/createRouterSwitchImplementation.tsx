...
export default <GenericPageName extends string>(...[partialConfig]: Parameters<createRouterInterface<GenericPageName>>) => {
    ...
    const Renderer = ({page, routes}:{page: GenericPageName, routes: RouteElementType<GenericPageName>[]}) => {
        ...
        const findRoute = (page: GenericPageName|undefined): RouteElementType<GenericPageName>|undefined  => {
            return routes.find(route => route.props.name === page);
        }
